...
OBJ_IS_NOT_TALKING @NTALK
OBJ_IS_NOT_FLAG $33,@N33
...
OBJ_STOP
    @NTALK:
OBJ_IS_NOT_CHECKING @END
OBJ_IS_NOT_FLAG $33,@N332
OBJ_JUMP @END
    @N332:
OBJ_DIALOGUE UMSG::MYHOME_DOG_CHECK
OBJ_NOT_HAS_ITEM $00,@INVFULL
;basement key
OBJ_PICK_ITEM $55
OBJ_GIVE_ITEM @END
...
OBJ_IS_NOT_FLAG $0B,@NOPIPPI
OBJ_DIALOGUE UMSG::PODUNK_PIPPIMOM_THANKS
OBJ_STOP
    @NOPIPPI:
OBJ_NOT_HAS_CHARACTER $05,@SKIP
OBJ_HAS_STATUS $80,@SKIP
...
OBJ_PICK_CHARACTER_ITEM $00,@UNK
OBJ_NOT_HAS_CHARACTER $01,(OBJ_BASE + $31)
OBJ_HAS_STATUS $80,(OBJ_BASE + $31)
OBJ_DIALOGUE UMSG::PODUNK_PIPPI_GOODS
    @GIVESTUFF:
OBJ_PICK_CHARACTER $05
OBJ_PICK_CHARACTER_ITEM $00,@NOSPACE
OBJ_PICK_CHARACTER $01
OBJ_GIVE_ITEM @NOROOM
OBJ_PLAY_SOUND $06
OBJ_PICK_CHARACTER $05
OBJ_REMOVE_ITEM @NOROOM
OBJ_JUMP @GIVESTUFF
    @NOSPACE:
...
OBJ_IS_NOT_TALKING @END
OBJ_NOT_HAS_ITEM $5F,@BABY
OBJ_DIALOGUE UMSG::CANARY_MAN_BABY
OBJ_YESNO_IS_NO @BABY_NO
...
OBJ_IS_NOT_FLAG $0C,@MAIN
OBJ_DIALOGUE UMSG::CANARY_MAN_MELODY
OBJ_YESNO_IS_NO @MELODY_NO
...
OBJ_IS_NOT_TALKING @CANARYCHICK
OBJ_IS_NOT_FLAG $0C,@NOMELODY
    @HAPPY:
OBJ_DIALOGUE UMSG::CANARY_SING
OBJ_JUMP @REPEAT_MELODY
    @NOMELODY:
OBJ_DIALOGUE UMSG::CANARY_LAURA
OBJ_STOP
    @CANARYCHICK:
OBJ_IS_NOT_USING $5F,@END
OBJ_NOT_HAS_ITEM $5F,@HAPPY
OBJ_PICK_ITEM $5F
OBJ_REMOVE_ITEM @END
...
.addr SPRITEDEF_CANARY ;sprite
OBJ_SUBROUTINE OBJ_CANARY_CANARY, OBJ_CANARY_CANARY_MAIN
OBJ_STOP
...
objectDef OBJ_TYPE::TRIGGER, $BD, DIRECTIONS::UP, $230
OBJ_IS_NOT_TOUCHING @END
OBJ_PLAY_MUSIC $0D
    @END:
OBJ_STOP

OBJ_GRAVEYARD_MUSICSWAP2:
objectDef OBJ_TYPE::TRIGGER, $BD, DIRECTIONS::UP, $22F
OBJ_IS_NOT_TOUCHING @END
OBJ_IS_NOT_FACING @END
OBJ_PLAY_MUSIC $06
    @END:
OBJ_STOP

OBJ_CANARY_SIGN:
objectDef $19, $84, DIRECTIONS::UP, $146
...
OBJ_MYHOME_SIGN:
objectDef $19, $B4, DIRECTIONS::UP, $140
.addr SPRITEDEF_SIGN ;sprite
OBJ_IS_NOT_CHECKING @END
...
objectDef OBJ_TYPE::DOOR, $E, DIRECTIONS::RIGHT, $126
...
OBJ_IS_NOT_FACING @END
OBJ_IS_NOT_TOUCHING @END
OBJ_IS_NOT_FLAG $C8,@INTRO
    @NORMAL_2:
OBJ_TELEPORT $12, $37d, 6, $86
OBJ_STOP
    @NORMAL:
OBJ_IS_NOT_FLAG $7D,@NORMAL_2
OBJ_TELEPORT $12, $37C, 6, $86
OBJ_STOP
    @INTRO:
OBJ_PICK_CHARACTER $01
OBJ_HAS_STATUS $FF,@NORMAL
OBJ_PICK_CHARACTER $02
OBJ_HAS_STATUS $FF,@NORMAL
OBJ_PICK_CHARACTER $04
OBJ_HAS_STATUS $FF,@NORMAL
OBJ_REMOVE_CHARACTER $04,@NORMAL
OBJ_SIGNAL $1C
    @END:
OBJ_STOP

OBJ_MTITOI_CABINHEALFAIL:
objectDef OBJ_TYPE::TRIGGER, $2, 6, $126
OBJ_IS_NOT_TOUCHING @END
OBJ_CLEAR_FLAG $7C
OBJ_IS_NOT_FACING @WHAT
OBJ_SET_FLAG $7C
    @WHAT:
OBJ_PICK_CHARACTER_J $00,@END
OBJ_HAS_STATUS $FF,@HEAL
OBJ_NOT_MAX_HEALTH @HEAL
OBJ_PICK_CHARACTER_J $01,@END
OBJ_HAS_STATUS $FF,@HEAL
OBJ_NOT_MAX_HEALTH @HEAL
OBJ_PICK_CHARACTER_J $02,@END
OBJ_HAS_STATUS $FF,@HEAL
OBJ_NOT_MAX_HEALTH @HEAL
OBJ_JUMP @END
    @HEAL:
...
OBJ_IS_SIGNAL @NOSIGNAL
OBJ_IS_NOT_FLAG $7C,@REMARK1
OBJ_MOVE @MOVE1
OBJ_JUMP @REMARK2
    @REMARK1:
OBJ_MOVE @MOVE3
...
OBJ_AND_STATUS $00
    @PARTY1_HEALLOOP:
OBJ_HEAL $FF
OBJ_NOT_MAX_HEALTH @PARTY1_HEALLOOP
    @PARTY1_HEALPPLOOP:
OBJ_PPHEAL $FF
OBJ_NOT_MAX_PP @PARTY1_HEALPPLOOP
OBJ_PICK_CHARACTER_J $01,@FINISHHEAL
OBJ_AND_STATUS $00
    @PARTY2_HEALLOOP:
OBJ_HEAL $FF
OBJ_NOT_MAX_HEALTH @PARTY2_HEALLOOP
    @PARTY2_HEALPPLOOP:
OBJ_PPHEAL $FF
OBJ_NOT_MAX_PP @PARTY2_HEALPPLOOP
OBJ_PICK_CHARACTER_J $02,@FINISHHEAL
OBJ_AND_STATUS $00
    @PARTY3_HEALLOOP:
OBJ_HEAL $FF
OBJ_NOT_MAX_HEALTH @PARTY3_HEALLOOP
    @PARTY3_HEALPPLOOP:
OBJ_PPHEAL $FF
OBJ_NOT_MAX_PP @PARTY3_HEALPPLOOP
    @FINISHHEAL:
OBJ_PLAY_SOUND $07
OBJ_IS_SIGNAL @END
OBJ_IS_NOT_FLAG $7C,@MOVEDO4
OBJ_MOVE @MOVE2
OBJ_JUMP @END
    @MOVEDO4:
OBJ_MOVE @MOVE4
