...
OBJ_IS_NOT_USING $64, @IJUSE0
OBJ_RESET_COUNTER $5
    @CNJCOMPCOUNTER2:
OBJ_NOT_HAS_ITEM $64, @IJHASITEM1
OBJ_SHOW_MONEY
OBJ_PICK_ITEM $64
OBJ_REMOVE_ITEM @IJHASITEM1
OBJ_INCREMENT_COUNTER $5
OBJ_COUNTERLESSTHAN $5, $A, @CNJCOMPCOUNTER2
OBJ_DIALOGUE UMSG::YUCCA_PILOT_TANK
OBJ_SET_FLAG $88
OBJ_STOP
    @IJHASITEM1:
OBJ_COUNTERLESSTHAN $5, $1, @CNJCOMPCOUNTER3
OBJ_NOT_HAS_ITEM $0, @CNJCOMPCOUNTER3
OBJ_PICK_ITEM $64
OBJ_GIVE_ITEM @CNJCOMPCOUNTER3
...
OBJ_STOP
    @IJUSE0:
OBJ_IS_NOT_TALKING @JTALK4
OBJ_IS_NOT_FLAG $88, @FJJUMP5
OBJ_DIALOGUE UMSG::YUCCA_PILOT_TANKRIDE
OBJ_STOP
    @FJJUMP5:
OBJ_IS_NOT_FLAG $3A, @FJJUMP6
OBJ_DIALOGUE UMSG::YUCCA_PILOT_RIDE
OBJ_YESNO_IS_NO @JYESNO7
OBJ_DIALOGUE UMSG::YUCCA_PILOT_CHOOSEPLAN
OBJ_DISPLAY_ITEMS $9C, $9D, $9E, $0, @JYESNO7-OBJ_YUCCA_PILOT
OBJ_CLEAR_FLAG $89
OBJ_CLEAR_FLAG $8A
OBJ_CLEAR_FLAG $8B
OBJ_IS_NOT_SELECTED $9C, @IJSELECTEDITEM8
OBJ_SET_FLAG $89
OBJ_JUMP @JUMP9
    @IJSELECTEDITEM8:
OBJ_IS_NOT_SELECTED $9D, @IJSELECTEDITEM10
OBJ_SET_FLAG $8A
OBJ_JUMP @JUMP9
    @IJSELECTEDITEM10:
OBJ_IS_NOT_SELECTED $9E, @JUMP9
OBJ_SET_FLAG $8B
    @JUMP9:
OBJ_RESET_COUNTER $0
OBJ_INCREMENT_COUNTER $0
OBJ_PICK_CHARACTER_J $1, @CJSELECTPARTY11
OBJ_HAS_STATUS $80, @SJPRESENT12
OBJ_INCREMENT_COUNTER $0
    @SJPRESENT12:
OBJ_PICK_CHARACTER_J $2, @CJSELECTPARTY11
OBJ_HAS_STATUS $80, @CJSELECTPARTY11
OBJ_INCREMENT_COUNTER $0
    @CJSELECTPARTY11:
OBJ_MULTIPLY_BY_PARTY
OBJ_DIALOGUE UMSG::YUCCA_PILOT_RIDE_ACCEPT
OBJ_TAKE_MONEY @JTAKEMONEY13
OBJ_RESET_COUNTER $6
    @JUMP16:
OBJ_COUNTERLESSTHAN $0, $1, @CNJCOMPCOUNTER14
OBJ_NOT_HAS_ITEM $0, @IJHASITEM15
OBJ_PICK_ITEM $64
OBJ_GIVE_ITEM @IJHASITEM15
OBJ_INCREMENT_COUNTER $6
OBJ_DECREMENT_COUNTER $0
OBJ_JUMP @JUMP16
    @IJHASITEM15:
OBJ_COUNTERLESSTHAN $6, $1, @CNJCOMPCOUNTER17
OBJ_NOT_HAS_ITEM $64, @JTALK4
OBJ_PICK_ITEM $64
OBJ_REMOVE_ITEM @JTALK4
OBJ_DECREMENT_COUNTER $6
OBJ_JUMP @IJHASITEM15
    @CNJCOMPCOUNTER17:
OBJ_DIALOGUE UMSG::YUCCA_PILOT_NOROOM
OBJ_IS_NOT_FLAG $89, @FJJUMP18
OBJ_PICK_ITEM $9C
OBJ_JUMP @JUMP19
    @FJJUMP18:
OBJ_IS_NOT_FLAG $8A, @FJJUMP20
OBJ_PICK_ITEM $9D
OBJ_JUMP @JUMP19
    @FJJUMP20:
OBJ_PICK_ITEM $9E
