...
OBJ_IS_NOT_FLAG 140, @J_IS_NOT_FLAG
...
OBJ_IS_NOT_FLAG 67, @J_IS_NOT_FLAG
...
OBJ_IS_NOT_FLAG 0, @J_IS_NOT_FLAG1
...
OBJ_STOP
	@J_IS_NOT_FLAG1:
.endif
OBJ_TAKE_MONEY @J_TAKE_MONEY
.ifdef VER_JP
OBJ_IS_NOT_SELECTED 167, @J_IS_NOT_SELECTED
...
OBJ_STOP
	@J_IS_NOT_SELECTED:
.endif
OBJ_IS_NOT_SELECTED 166, @J_IS_NOT_SELECTED1
OBJ_DIALOGUE UMSG::TWINKLE_SCIENTISTROCKET1
OBJ_DIALOGUE UMSG::TWINKLE_SCIENTISTROCKET2
OBJ_PLAY_SOUND2 9
...
OBJ_STOP
	@J_GIVE_ITEM:
.ifdef VER_JP
OBJ_GIVE_MONEY @J_IS_NOT_TALKING
OBJ_DIALOGUE UMSG::YUCCA_PILOT_NOROOM
OBJ_DIALOGUE UMSG::TWINKLE_SCIENTIST_GOODBYE
OBJ_STOP
.endif
...
OBJ_ADD_CHARACTER 3, @J_IS_NOT_TOUCHING
OBJ_SET_FLAG 118
OBJ_SET_FLAG 70
OBJ_CLEAR_FLAG 36
OBJ_TELEPORT 0, 917, DIRECTIONS::RIGHT, 134
...
OBJ_PLAY_SOUND 7
OBJ_PICK_CHARACTER_J 0, @J_IS_NOT_TALKING
OBJ_HAS_STATUS %10000000, @J_HAS_STATUS
OBJ_HEAL 80
	@J_HAS_STATUS:
OBJ_PICK_CHARACTER_J 1, @J_IS_NOT_TALKING
OBJ_HAS_STATUS %10000000, @J_HAS_STATUS1
OBJ_HEAL 80
	@J_HAS_STATUS1:
OBJ_PICK_CHARACTER_J 2, @J_IS_NOT_TALKING
OBJ_HAS_STATUS %10000000, @J_IS_NOT_TALKING
OBJ_HEAL 80
	@J_IS_NOT_TALKING:
OBJ_STOP
...
OBJ_IS_NOT_TALKING @J_IS_NOT_TALKING
OBJ_IS_NOT_FLAG 127, @J_IS_NOT_FLAG
OBJ_DIALOGUE UMSG::ELLAY_FAKEHEALER_ASK
OBJ_MENU UMSG::ELLAY_FAKEHEALER_MENU, @J_MENU, @J_MENU1
...
OBJ_PICK_CHARACTER_ITEM 0, @J_PICK_CHARACTER_ITEM
OBJ_REMOVE_ITEM (OBJ_BASE + $2e) ;unconditional
OBJ_IS_NOT_SELECTED 3, @ISNT_BREADCRUMBS
OBJ_JUMP @J_JUMP
	@ISNT_BREADCRUMBS:
OBJ_PICK_CHARACTER 3
OBJ_GIVE_ITEM @J_PICK_CHARACTER_ITEM
OBJ_JUMP @J_JUMP
...
OBJ_NOT_MAX_HEALTH @J_NOT_MAX_HEALTH
	@J_NOT_MAX_PP:
OBJ_PPHEAL 255
OBJ_NOT_MAX_PP @J_NOT_MAX_PP
OBJ_PLAY_MUSIC 33
OBJ_DELAY 180
OBJ_PLAY_MUSIC 27
.ifdef VER_JP
OBJ_ADD_CHARACTER 3, (OBJ_BASE + $61) ;unconditional
.else
OBJ_ADD_CHARACTER 3, (OBJ_BASE + $62) ;unconditional
.endif
OBJ_CLEAR_FLAG 142
OBJ_SIGNAL 14
OBJ_MOVE @MOVE_DATA_3
...
OBJ_STOP
	@J_IS_NOT_CHECKING:
OBJ_IS_NOT_TALKING @J_IS_NOT_TALKING
OBJ_IS_NOT_FLAG 141, @J_IS_NOT_FLAG
OBJ_DIALOGUE UMSG::CANARY_GENERIC
OBJ_STOP
	@J_IS_NOT_FLAG:
...
OBJ_STOP
	@J_IS_NOT_TALKING:
OBJ_IS_NOT_CASTING 1, @J_IS_NOT_CASTING
OBJ_IS_NOT_FLAG 148, @J_IS_NOT_FLAG
